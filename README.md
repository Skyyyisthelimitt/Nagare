...
This project requires a Google Gemini API key for mood analysis and music recommendations.

1. Obtain an API key from the Google AI Studio.
2. Add the key as an environment variable in your deployment dashboard:
   - Key: `NEXT_PUBLIC_GEMINI_API_KEY`

## Deployment

Nagare is optimized for deployment on Vercel. Ensure all environment variables are configured in the project dashboard before building.
